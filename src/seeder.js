...
mongoose_1["default"].connect(config_1["default"].get('mongodbUri'));
// read  JSON FILES
var users = JSON.parse(fs_1["default"].readFileSync("".concat(__dirname, "/_data/Users.json"), 'utf-8'));
...
var importData = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, User_1["default"].create(users)];
            case 1:
                _a.sent();
